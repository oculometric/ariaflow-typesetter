...
void main()
{
    ...
    else if (draw_mode == 1)    // 9-slice mode
    {
        ...
        uint borders = uint(round(colour_2.z));
        int slice = int(round(colour_2.y));
